...
png('C:/Users/santibka/repo/ExData_Plotting1/plot1.png', height = 480, width = 480)
hist(chartData1$global_active_power, col= "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
dev.off()