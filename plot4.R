...
png('C:/Users/santibka/repo/ExData_Plotting1/plot4.png', height = 480, width = 480)
par(mfrow = c(2, 2), mar =c(4,4,2,1), oma = c(0, 0, 2,0))
plot(chartData1$date_time, chartData1$global_active_power, type="l", ylab = "Global Active Power", xlab = "")
plot(chartData1$date_time, chartData1$voltage, type="l", xlab = "datetime", ylab = "Voltage")
...
plot(chartData1$date_time, chartData1$global_reactive_power, type="l", ylab = "Global_reactive_power", xlab = "")
dev.off()